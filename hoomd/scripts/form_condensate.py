...
resize_steps=100000 # Number of steps (>500) to be used for resizing the box to boxsize set previously
if resize_steps<500:
    resize_steps=501
...
hoomd.dump.gsd('restart_tmp2.gsd', period=1000000, group=all, truncate=True)
